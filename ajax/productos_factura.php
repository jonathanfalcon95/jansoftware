...
date_default_timezone_set('America/Caracas');
	...
	if($action == 'ajax'){
		...
		if ( $_GET['q'] != "" )
		{
			...
			$sWhere .= ' ) and status_producto=1 order by nombre_producto asc';
                      
		}  else {
                    $sWhere .= 'where status_producto=1 order by nombre_producto asc';
                }
...
<!--                                        <th>Descripcion</th>-->
					...
					<th><span class="pull-right">Cant.</span></th>
                                        <th><span class="pull-right">Precio Bs</span></th>
					<th><span class="pull-right">Precio+IVA Bs</span></th>
...
//                                        $descripcion=$row['descripcion'];
					...
					$precio=$precio_venta+($precio_venta*$iva)/100;
...
<!--                                                <td><?php // echo $descripcion; ?></td>-->
						...
						<div class="pull-right">
                                                    <input type="number" disabled="" class="form-control" style="text-align:right" id="stock_<?php echo $id_producto; ?>"  value="<?php echo $stock; ?>" >
						</div></td>
						<td class='col-xs-1'>
						<div class="pull-right">
