...
date_default_timezone_set('America/Caracas');
	...
	if (empty($_POST['mod_id'])) {
           ...
           $errors[] = "Código vacío";
			...
			$errors[] = "descripcion del producto vacía";
		...
		} else if (empty($_POST['mod_precioC'])){
		...
		$precio_compra=floatval($_POST['mod_precioC']);
		$id_producto=$_POST['mod_id'];
		$sql="UPDATE products SET codigo_producto='".$codigo."', nombre_producto='".$nombre."',descripcion='".$descripcion."' ,stock='".$stock."', status_producto='".$estado."',precio_compra='".$precio_compra."', precio_producto='".$precio_venta."' WHERE id_producto='".$id_producto."'";
