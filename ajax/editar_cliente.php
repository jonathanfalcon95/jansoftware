...
date_default_timezone_set('America/Caracas');
	...
	if (empty($_POST['mod_id'])) {
		...
		$sql="UPDATE clientes SET  cedula='".$cedula."', nombre_cliente='".$nombre."', telefono_cliente='".$telefono."', direccion_cliente='".$direccion."', status_cliente='".$estado."' WHERE id_cliente='".$id_cliente."'";
