...
date_default_timezone_set('America/Caracas');
	...
	if (isset($_GET['id'])){
		...
		if ($count==0){
			if ($delete1=mysqli_query($con,"UPDATE products SET status_producto='2' WHERE id_producto='".$id_producto."'")){
			?>
	...
	if($action == 'ajax'){
		...
		if ( $_GET['q'] != "" )
		{
			$sWhere = "WHERE status_producto=1 and (";
			  ...
			  <table class="table table-condensed table-hover">
				<tr  class="primary">
					...
					<th class='text-right'>Precio</th>
                                        ...
                                        <th class='text-right'>Precio+IVA</th>
