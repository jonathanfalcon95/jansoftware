  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label for="costo" class="col-sm-2 control-label">Costo de Compra</label>
            <div class="col-sm-6">
              <input type="number" step="any" onkeyup='calcularpvp1();' name="costo" class="form-control" id="costo" value="" placeholder="Costo de compra">
            </div>
          </div>
           <div class="form-group">
            <label for="costo" class="col-sm-2 control-label">Precio de venta</label>
            <div class="col-sm-6">
              <input type="number" step="any"  name="precio" class="form-control" id="precio" value="" placeholder="pvp actualizado">
            </div>
          </div>
          <div class="form-group">
